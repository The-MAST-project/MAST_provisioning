# MAST Provisioning - Architecture Decisions, 2026-05-04 to 2026-08-03 (archive)

> **FROZEN ARCHIVE -- do not append and do not edit.** This was `DECISIONS.md` at the repo
> root until 2026-08-07, when decision records moved to one file per decision in this
> directory. It is kept **whole rather than split**: the 118 entries below stay exactly as
> written, in their original reverse-chronological order.
>
> - **New decisions** go in a dated file here -- format: `README.md` in this directory.
> - **This file stays authoritative** for everything it covers and must be **searched
>   alongside** the individual records. It is the only place the pre-2026-08-07 rationale
>   exists.
> - **Why the move:** `2026-08-07-decision-records-are-one-file-each.md`.
>
> Note when following an older `see DECISIONS.md <date>` citation from code or docs: 24
> dates below carry more than one entry (`2026-08-02` has nine), so a bare date may be
> ambiguous. Read the neighboring entries rather than assuming the first match.
