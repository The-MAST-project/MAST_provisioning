...
|  2750 | `desktop-appearance` | Dark Windows theme + a dark background carrying the machine's identity (hostname, site spelled out, site coordinates), written into the autologin `mast` hive and re-asserted in that session by an AtLogon task |
